package com.tarefas.android.Tarefa1;
                    ...
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if(task.isSuccessful()){
                                ...
                                ArrayAdapter myAdapter = new ArrayAdapter<String>(Tarefa1Activity.this,android.R.layout.simple_list_item_1,produtos);
                                listaProdutos.setAdapter(myAdapter);
                                String valor_formatado = "R$ %.2f";
                                textTotal.setText(String.format(valor_formatado, total));
                            }else{
                                Toast.makeText(Tarefa1Activity.this, "Não foi possivel recuperar os dados.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
            ...
            db.collection("Produtos")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        ...
                        public void onSuccess(DocumentReference documentReference) {
                            Toast.makeText(Tarefa1Activity.this, "Produto " + documentReference.getId() + " Adicionado.", Toast.LENGTH_SHORT).show();
                            recuperarDados();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Tarefa1Activity.this, "Produto não adicionado.", Toast.LENGTH_SHORT).show();
                        }
                    });
